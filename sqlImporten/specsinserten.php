...
$specsPC = [
  ...
  $data = $pdo->prepare("INSERT INTO `products` (`productname`, `price`, `pictures`, `maincategorie`, `subcategorie`, `specificaties`) VALUES 
        ...
        ('GIGABYTE Z590 AORUS Master', 299.99 , 'moederbord1.jpg', 'components', 'motherboard', '$dbSpecMotherboard'),
        ('MSI MPG B550 Gaming Plus', 117.00 , 'moederbord2.jpg', 'components', 'motherboard', '$dbSpecMotherboard1'),
        ('Andifany X79 Moederbord', 148.98 , 'moederbord3.jpg', 'components', 'motherboard', '$dbSpecMotherboard2'),
        ...
        ('Gembird FANPS Computer behuizing Ventilator', 4.95 , 'vent1.jpg', 'components', 'fans', '$dbSpecFans'),
        ('Noctua NF-A8 PWM, 80mm', 15.95 , 'vent2.jpg', 'components', 'fans', '$dbSpecFans1'),
        ('Titan TFD-8025M12B Computer Ventilator', 29.95 , 'vent3.jpg', 'components', 'fans', '$dbSpecFans2'),
        ('Gigabyte Modulaire - 850W', 124.55 , 'voeding1.jpg', 'components', 'powersupply', '$dbSpecPowersupply'),
        ('Aerocool LUX850 - 850W', 75.90 , 'voeding2.jpg', 'components', 'powersupply', '$dbSpecPowersupply1'),
        ('MSI MPG A850GF - 850W', 133.15 , 'voeding3.jpg', 'components', 'powersupply', '$dbSpecPowersupply2'),
        ...
        ('OMEN Encoder Mechanical Gaming Keyboard', 49.00 , 'keyboard2.jpg', 'peripherals', 'keyboard', '$dbSpeckeyboard1'),
