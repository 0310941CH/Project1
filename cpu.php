...
<body>
    ...
    if (count($data) != 0) {
        echo '<a href="cpu.php?sort=nAsc"><button class ="orderbutton">ABC▲</button></a>
        <a href="cpu.php?sort=nDesc"><button class ="orderbutton">ABC▼</button></a>
        <a href="cpu.php?sort=pAsc"><button class ="orderbutton">€▲</button></a>
        <a href="cpu.php?sort=pDesc"><button class ="orderbutton">€▼</button></a>';
        }
        echo '</div>';
    ...
    foreach ($data as $product) {
        ...
        echo "€ " . $product["price"];
        echo "<br>";
        echo "<a href='product.php?pid=" . $product["id"] . "&category=cpu'>Details werkt nog niet</a>";
        echo "<br>";  
