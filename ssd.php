...
<body>
    ...
    if (isset($_GET["sort"])) {
        ...
        <a href="ssd.php?sort=nDesc"><button class ="orderbutton">ABC▼</button></a>
        <a href="ssd.php?sort=pAsc"><button class ="orderbutton">€▲</button></a>
        <a href="ssd.php?sort=pDesc"><button class ="orderbutton">€▼</button></a>';
        }
        echo '</div>';
        ...
        foreach ($data as $product) {
            ...
            echo "<br>";
            echo "<a class='shopbutton' href='cart_add.php?id=" . $product["id"] . "&&page=ssd.php'>Add to cart</a>";
            echo "</div>";
            echo "</div>";
        }
    } else {
