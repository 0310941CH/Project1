...
<body>
    ...
    if (isset($_GET["sort"])) {
        ...
        if (count($data) != 0) {
            echo '<a href="adminmotherboard.php?sort=nAsc"><button class ="orderbutton">ABC▲</button></a>
        <a href="adminmotherboard.php?sort=nDesc"><button class ="orderbutton">ABC▼</button></a>
        <a href="adminmotherboard.php?sort=pAsc"><button class ="orderbutton">€▲</button></a>
        <a href="adminmotherboard.php?sort=pDesc"><button class ="orderbutton">€▼</button></a>';
        }
        echo '</div>';
