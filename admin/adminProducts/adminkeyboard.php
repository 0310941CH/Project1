...
<body>
    ...
    if (isset($_GET["sort"])) {
        ...
        if (count($data) != 0) {
            echo '<a href="adminkeyboard.php?sort=nAsc"><button class ="orderbutton">ABC▲</button></a>
        <a href="adminkeyboard.php?sort=nDesc"><button class ="orderbutton">ABC▼</button></a>
        <a href="adminkeyboard.php?sort=pAsc"><button class ="orderbutton">€▲</button></a>
        <a href="adminkeyboard.php?sort=pDesc"><button class ="orderbutton">€▼</button></a>';
        }
        echo '</div>';
